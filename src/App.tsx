...
export default function App() {
  ...
  // Simulation level: 0 to 50 (causes 1-7 funded — Malaria Nets, Tuberculosis, Cataract Backlog, Midday School Meals, Girls' Education, Clean Air Advocacy, Childhood Deworming)
  const [progressIndex, setProgressIndex] = useState<number>(7);
